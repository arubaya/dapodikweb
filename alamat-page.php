    ...
    <div class="tabcontent" id="Sleman">
      ...
      <div class="table-container" style="overflow-x: auto;">
        <table id="myTable">
          ...
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NAMA_SEKOLAH`, `t_identitas`.`NPSN`, `t_alamat`.`ALAMAT`, `t_alamat`.`RT`, `t_alamat`.`RW`, `t_alamat`.`KODE_POS`, `t_alamat`.`KELURAHAN`, `t_alamat`.`KECAMATAN`, `t_alamat`.`KABUPATEN`, `t_alamat`.`PROVINSI`, `t_alamat`.`GEO_LINTANG`, `t_alamat`.`GEO_BUJUR`
                      FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['ALAMAT']."</td>";
                  echo "<td>".$sekolah['RT']."</td>";
                  echo "<td>".$sekolah['RW']."</td>";
                  echo "<td>".$sekolah['KODE_POS']."</td>";
                  echo "<td>".$sekolah['KELURAHAN']."</td>";
                  echo "<td>".$sekolah['KECAMATAN']."</td>";
                  echo "<td>".$sekolah['KABUPATEN']."</td>";
                  echo "<td>".$sekolah['PROVINSI']."</td>";
                  echo "<td>".$sekolah['GEO_LINTANG']."</td>";
                  echo "<td>".$sekolah['GEO_BUJUR']."</td>";
