    ...
    <div class="tabcontent" id="Sleman">
      ...
      <div class="table-container" style="overflow-x: auto;">
        <table id="myTable">
          ...
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_kontak`.`TELP`, `t_kontak`.`FAX`, `t_kontak`.`EMAIL`, `t_kontak`.`WEB`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['TELP']."</td>";
                  echo "<td>".$sekolah['FAX']."</td>";
                  echo "<td>".$sekolah['EMAIL']."</td>";
                  echo "<td>".$sekolah['WEB']."</td>";
