    ...
    <div class="tabcontent" id="Sleman">
      ...
      <div class="table-container" style="overflow-x: auto;">
        <table id="myTable">
          ...
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_perizinan`.`SK_OPERASIONAL`, `t_perizinan`.`TGL_OPERASIONAL`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['SK_OPERASIONAL']."</td>";
                  echo "<td>".$sekolah['TGL_OPERASIONAL']."</td>";
