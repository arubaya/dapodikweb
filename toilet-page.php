    ...
    <div class="tabcontent" id="Sleman">
      ...
      <div class="table-container" style="overflow-x: auto;">
        <table id="myTable">
          ...
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_sanitasi`.`TIPE_JAMBAN`, `t_sanitasi`.`JAMBAN_BAGUS`, `t_sanitasi`.`JAMBAN_RUSAK`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['TIPE_JAMBAN']."</td>";
                  echo "<td>".$sekolah['JAMBAN_BAGUS']."</td>";
                  echo "<td>".$sekolah['JAMBAN_RUSAK']."</td>";
