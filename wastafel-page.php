        ...
        <table id="myTable">
          <thead>
            <tr>
              <th>Nama</th>
              <th>NPSN</th>
              <th>Jumlah Wastafel</th>
              <th>Terdapat Sabun</th>
            </tr>
          </thead>
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_sanitasi`.`JML_WASTAFEL`, `t_sanitasi`.`SABUN_WASTAFEL`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['JML_WASTAFEL']."</td>";
                  echo "<td>".$sekolah['SABUN_WASTAFEL']."</td>";
