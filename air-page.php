        ...
        <table id="myTable">
          <thead>
            <tr>
              ...
              <th>NPSN</th>
              <th>Sumber Air</th>
              <th>Air di Lingkungan Sekolah</th>
              <th>Memproduksi Air Minum</th>
              <th>Minum Untuk Siswa</th>
              <th>Siswa Membawa Air</th>
            </tr>
          </thead>
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_sanitasi`.`AIR_MANDIRI`, `t_sanitasi`.`MINUM_SISWA`, `t_sanitasi`.`BAWA_AIR`, `t_sanitasi`.`SUMBER_AIR`, `t_sanitasi`.`AIR_LINGKUNGAN`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['SUMBER_AIR']."</td>";
                  echo "<td>".$sekolah['AIR_LINGKUNGAN']."</td>";
                  echo "<td>".$sekolah['AIR_MANDIRI']."</td>";
                  echo "<td>".$sekolah['MINUM_SISWA']."</td>";
                  echo "<td>".$sekolah['BAWA_AIR']."</td>";
