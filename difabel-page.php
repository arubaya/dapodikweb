        ...
        <table id="myTable">
          <thead>
            <tr>
              <th>Nama</th>
              <th>NPSN</th>
              <th>Layanan Difabel</th>
              <th>Toilet Difabel</th>
            </tr>
          </thead>
          <tbody>
            <?php
              $sql = "SELECT `t_identitas`.`NPSN`, `t_identitas`.`NAMA_SEKOLAH`, `t_pelengkap`.`LAYANAN_DIFABEL`, `t_sanitasi`.`TOILET_DIFABEL`
              FROM `t_identitas` 
              ...
              while($sekolah = mysqli_fetch_array($query)){
                  ...
                  echo "<td>".$sekolah['LAYANAN_DIFABEL']."</td>";
                  echo "<td>".$sekolah['TOILET_DIFABEL']."</td>";
